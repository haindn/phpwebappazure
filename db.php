...
try {
    $conn = new PDO("sqlsrv:server = tcp:haiwebserver.database.windows.net,1433; Database = ProductsDB", "server4scaprj", "!Sca22Proj");
...
$serverName = "tcp:haiwebserver.database.windows.net,1433";
